...
import com.danieloliveira.cursomc.domain.Pagamento;
import com.danieloliveira.cursomc.domain.PagamentoComBoleto;
import com.danieloliveira.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Daniel Oliveira", "danielcompositor1307@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Seu Madruga", "danielssdo@unicid.edu.br", "87558627052", TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("22452644", "94849449"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Vila", "14", "N/A", "Centro", "38777012", cli2, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 19:32:00"), cli1, e2);
